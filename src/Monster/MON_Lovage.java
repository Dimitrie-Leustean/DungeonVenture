...
public class MON_Lovage extends Entity {

    GamePanel gp;
    public static final String monName = "Great Lovage";

    public MON_Lovage(GamePanel gp) {
        super(gp);
        this.gp = gp;
    ...
    public void setDialogue(){
        dialogues[0][0] = "You dare approach me, Lovage the Ogre?";
        dialogues[0][1] = "I hold absolute dominion over this realm.";
        dialogues[0][2] = "Fall under the uncontestable strength of my weapon!";
    }
